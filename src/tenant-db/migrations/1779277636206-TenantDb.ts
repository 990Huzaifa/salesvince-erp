...
export class TenantDb1779277636206 implements MigrationInterface {
    name = 'TenantDb1779277636206'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderNumber" character varying NOT NULL, "orderStatus" "public"."sale_orders_orderstatus_enum" NOT NULL, "orderTotal" integer NOT NULL, "taxPercentage" integer NOT NULL DEFAULT '0', "taxAmount" integer NOT NULL DEFAULT '0', "discountPercentage" integer NOT NULL DEFAULT '0', "discountAmount" integer NOT NULL DEFAULT '0', "totalAmount" integer NOT NULL DEFAULT '0', "notes" character varying, "createdBy" uuid, "orderDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ca1959beef162c2ccace1481cec" UNIQUE ("orderNumber"), CONSTRAINT "PK_ba301b7939d3333e8821ff92637" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sale_order_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "saleOrderId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer, "uomId" uuid NOT NULL, "purchaseUnitPrice" integer NOT NULL, "saleUnitPrice" integer NOT NULL, "quantity" integer NOT NULL, "discountPercentage" integer NOT NULL DEFAULT '0', "discountAmount" integer NOT NULL DEFAULT '0', "totalAmount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c46724b3d93b4c233ca288871a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "purchase_quotation_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "purchaseQuotationId" uuid NOT NULL, "productId" uuid NOT NULL, "uomId" uuid NOT NULL, "quantity" integer NOT NULL, "unitPrice" integer NOT NULL, "totalPrice" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a532500070b8d3c171f91bce2ef" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "businessId" uuid NOT NULL, "categoryId" uuid NOT NULL, "subCategoryId" uuid NOT NULL, "skuCode" character varying NOT NULL, "name" character varying NOT NULL, "batchPickStrategy" "public"."products_batchpickstrategy_enum" NOT NULL DEFAULT 'LIFO', "hsCode" character varying, "description" character varying, "brandId" uuid, "image" character varying, "chartOfAccountId" uuid, "isActive" boolean NOT NULL DEFAULT true, "isDelete" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" uuid, CONSTRAINT "UQ_65ac74fb678576a4a9865d7eaf6" UNIQUE ("skuCode"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "purchase_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderNumber" character varying NOT NULL, "warehouseId" uuid NOT NULL, "vendorId" uuid NOT NULL, "orderStatus" "public"."purchase_orders_orderstatus_enum" NOT NULL, "orderTotal" numeric(18,2) NOT NULL, "deliveryCost" numeric(18,2) NOT NULL DEFAULT '0', "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "notes" character varying, "createdBy" uuid NOT NULL, "orderDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_0a4ef1738b13da938b62393dc04" UNIQUE ("orderNumber"), CONSTRAINT "PK_05148947415204a897e8beb2553" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "purchase_order_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "purchaseOrderId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer, "uomId" uuid NOT NULL, "purchaseUnitPrice" integer NOT NULL, "saleUnitMarginAmount" integer NOT NULL, "saleUnitMarginPercentage" integer NOT NULL, "quantity" integer NOT NULL, "discountPercentage" integer NOT NULL DEFAULT '0', "discountAmount" integer NOT NULL DEFAULT '0', "totalAmount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e8b7568d25c41e3290db596b312" PRIMARY KEY ("id"))`);
