...
export class TenantDb1779529922277 implements MigrationInterface {
    name = 'TenantDb1779529922277'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderNumber" character varying NOT NULL, "orderStatus" "public"."sale_orders_orderstatus_enum" NOT NULL, "orderTotal" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL DEFAULT '0', "taxAmount" numeric(18,2) NOT NULL DEFAULT '0', "discountPercentage" numeric(18,2) NOT NULL DEFAULT '0', "discountAmount" numeric(18,2) NOT NULL DEFAULT '0', "totalAmount" numeric(18,2) NOT NULL DEFAULT '0', "notes" character varying, "createdBy" uuid, "orderDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ca1959beef162c2ccace1481cec" UNIQUE ("orderNumber"), CONSTRAINT "PK_ba301b7939d3333e8821ff92637" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "purchase_quotations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quotationNumber" character varying NOT NULL, "vendorId" uuid NOT NULL, "quotationDate" TIMESTAMP NOT NULL, "notes" character varying, "createdBy" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_92b2b397a788a1013a508ca5488" PRIMARY KEY ("id"))`);
