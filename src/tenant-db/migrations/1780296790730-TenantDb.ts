...
export class TenantDb1780296790730 implements MigrationInterface {
    name = 'TenantDb1780296790730'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_invoice_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "saleInvoiceId" uuid NOT NULL, "productId" uuid NOT NULL, "uomId" uuid NOT NULL, "productFlavourId" integer, "quantity" integer NOT NULL, "saleUnitPrice" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_f6ee1370c1e9511ec59ca68118f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "delivery_note_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deliveryNoteId" uuid NOT NULL, "saleOrderItemId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer, "uomId" uuid NOT NULL, "orderedQuantity" integer NOT NULL, "deliveredQuantity" integer NOT NULL, "saleUnitPrice" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, CONSTRAINT "PK_d0093bd2efb0757f8142f11f027" PRIMARY KEY ("id"))`);
