...
export class TenantDb1779854711934 implements MigrationInterface {
    name = 'TenantDb1779854711934'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_returns" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "saleInvoiceId" uuid NOT NULL, "returnNumber" character varying NOT NULL, "returnDate" TIMESTAMP NOT NULL, "returnReason" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "businessId" uuid, CONSTRAINT "UQ_ec0e8c65946664439f27e8a1d21" UNIQUE ("returnNumber"), CONSTRAINT "PK_0dacb97f81ef1ca47f61409f844" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sale_return_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "saleReturnId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer, "uomId" uuid NOT NULL, "quantity" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_87c0813662620cbb412d65c0cc4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sale-invoices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "businessId" uuid NOT NULL, "deliveryNoteId" uuid NOT NULL, "customerId" uuid NOT NULL, "saleOrderId" uuid NOT NULL, "invoiceNumber" character varying NOT NULL, "invoiceDate" TIMESTAMP NOT NULL, "totalTaxAmount" numeric(18,2) NOT NULL, "totalDiscountAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_d22759fb7eebcae4d043070607d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sale-invoice-items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "saleInvoiceId" uuid NOT NULL, "productId" uuid NOT NULL, "uomId" uuid NOT NULL, "productFlavourId" integer, "quantity" integer NOT NULL, "saleUnitPrice" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_e2cb744b54166353da659059acd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "delivery_notes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "businessId" uuid NOT NULL, "saleOrderId" uuid NOT NULL, "warehouseId" uuid NOT NULL, "customerId" uuid NOT NULL, "deliveryNoteNumber" character varying NOT NULL, "deliveryNoteDate" TIMESTAMP NOT NULL, "notes" character varying, "deliveryCost" numeric(18,2) NOT NULL, "totalTaxAmount" numeric(18,2) NOT NULL, "totalDiscountAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "status" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_a15e1b336a427fcbedeb36c9531" UNIQUE ("deliveryNoteNumber"), CONSTRAINT "PK_8ba22b28b7392ac676c680dd5d2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "delivery-note-items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deliveryNoteId" uuid NOT NULL, "saleOrderItemId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer, "uomId" uuid NOT NULL, "orderedQuantity" integer NOT NULL, "deliveredQuantity" integer NOT NULL, "saleUnitPrice" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, CONSTRAINT "PK_9902d2fd4445307c2a63ede44b9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."sale_orders_orderstatus_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED')`);
        await queryRunner.query(`CREATE TABLE "sale_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "businessId" uuid NOT NULL, "warehouseId" uuid NOT NULL, "customerId" uuid NOT NULL, "orderNumber" character varying NOT NULL, "orderStatus" "public"."sale_orders_orderstatus_enum" NOT NULL, "orderTotal" numeric(18,2) NOT NULL, "deliveryCost" numeric(18,2) NOT NULL DEFAULT '0', "taxPercentage" numeric(18,2) NOT NULL DEFAULT '0', "taxAmount" numeric(18,2) NOT NULL DEFAULT '0', "discountPercentage" numeric(18,2) NOT NULL DEFAULT '0', "discountAmount" numeric(18,2) NOT NULL DEFAULT '0', "totalAmount" numeric(18,2) NOT NULL DEFAULT '0', "notes" character varying, "createdBy" uuid, "orderDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ca1959beef162c2ccace1481cec" UNIQUE ("orderNumber"), CONSTRAINT "PK_ba301b7939d3333e8821ff92637" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sale_returns" ADD CONSTRAINT "FK_59d9530b33ba6ad0e19b626fe0b" FOREIGN KEY ("saleInvoiceId") REFERENCES "sale-invoices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sale-invoices" ADD CONSTRAINT "FK_64ee7885a942d26960786cafd45" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" ADD CONSTRAINT "FK_5249784b4dcd764e4c30427fa43" FOREIGN KEY ("deliveryNoteId") REFERENCES "delivery_notes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" ADD CONSTRAINT "FK_d8efd816299b58c59f4c0984276" FOREIGN KEY ("customerId") REFERENCES "parties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" ADD CONSTRAINT "FK_856982fd597cf8baaf9ad968165" FOREIGN KEY ("saleOrderId") REFERENCES "sale_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" ADD CONSTRAINT "FK_d8507f682badfcf6f81be09517b" FOREIGN KEY ("saleInvoiceId") REFERENCES "sale-invoices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" ADD CONSTRAINT "FK_2ca6eb69e97fd347a3a13f117bf" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" ADD CONSTRAINT "FK_018f9f0c3d8037152ca4da13bf0" FOREIGN KEY ("uomId") REFERENCES "uoms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" ADD CONSTRAINT "FK_0cb7c3bc31ea1d9182656a44194" FOREIGN KEY ("productFlavourId") REFERENCES "product_flavours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "delivery_notes" ADD CONSTRAINT "FK_4872624e79e97c487aacddb5e98" FOREIGN KEY ("warehouseId") REFERENCES "warehouses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "delivery-note-items" ADD CONSTRAINT "FK_ea206169499491aea52731d12fb" FOREIGN KEY ("deliveryNoteId") REFERENCES "delivery_notes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" ADD CONSTRAINT "FK_45cd8df0bc8d86e4f66eae23080" FOREIGN KEY ("saleOrderItemId") REFERENCES "sale_order_items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" ADD CONSTRAINT "FK_bab6c5e093394dda79f1b2ad5b5" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" ADD CONSTRAINT "FK_96484856e30a2943816dabb212f" FOREIGN KEY ("productFlavourId") REFERENCES "product_flavours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" ADD CONSTRAINT "FK_de38c3905cced51013ac6734f41" FOREIGN KEY ("uomId") REFERENCES "uoms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "delivery-note-items" DROP CONSTRAINT "FK_de38c3905cced51013ac6734f41"`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" DROP CONSTRAINT "FK_96484856e30a2943816dabb212f"`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" DROP CONSTRAINT "FK_bab6c5e093394dda79f1b2ad5b5"`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" DROP CONSTRAINT "FK_45cd8df0bc8d86e4f66eae23080"`);
        await queryRunner.query(`ALTER TABLE "delivery-note-items" DROP CONSTRAINT "FK_ea206169499491aea52731d12fb"`);
        await queryRunner.query(`ALTER TABLE "delivery_notes" DROP CONSTRAINT "FK_f5c9dbf55d00344cb4593071d2f"`);
        await queryRunner.query(`ALTER TABLE "delivery_notes" DROP CONSTRAINT "FK_4872624e79e97c487aacddb5e98"`);
        ...
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" DROP CONSTRAINT "FK_0cb7c3bc31ea1d9182656a44194"`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" DROP CONSTRAINT "FK_018f9f0c3d8037152ca4da13bf0"`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" DROP CONSTRAINT "FK_2ca6eb69e97fd347a3a13f117bf"`);
        await queryRunner.query(`ALTER TABLE "sale-invoice-items" DROP CONSTRAINT "FK_d8507f682badfcf6f81be09517b"`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" DROP CONSTRAINT "FK_856982fd597cf8baaf9ad968165"`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" DROP CONSTRAINT "FK_d8efd816299b58c59f4c0984276"`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" DROP CONSTRAINT "FK_5249784b4dcd764e4c30427fa43"`);
        await queryRunner.query(`ALTER TABLE "sale-invoices" DROP CONSTRAINT "FK_64ee7885a942d26960786cafd45"`);
        ...
        await queryRunner.query(`DROP TABLE "delivery-note-items"`);
        await queryRunner.query(`DROP TABLE "delivery_notes"`);
        await queryRunner.query(`DROP TABLE "sale-invoice-items"`);
        await queryRunner.query(`DROP TABLE "sale-invoices"`);
