...
export class TenantDb1779696057834 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "purchase-invoices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "businessId" uuid NOT NULL, "grnId" uuid NOT NULL, "purchaseOrderId" uuid NOT NULL, "invoiceNumber" character varying NOT NULL, "invoiceDate" TIMESTAMP NOT NULL, "totalTaxAmount" numeric(18,2) NOT NULL, "totalDiscountAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_fe6ae1dad3a6567ba45f2ed0b50" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "purchase-invoice-items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "purchaseInvoiceId" uuid NOT NULL, "productId" uuid NOT NULL, "uomId" uuid NOT NULL, "quantity" integer NOT NULL, "purchaseUnitPrice" numeric(18,2) NOT NULL, "discountPercentage" numeric(18,2) NOT NULL, "discountAmount" numeric(18,2) NOT NULL, "taxPercentage" numeric(18,2) NOT NULL, "taxAmount" numeric(18,2) NOT NULL, "totalAmount" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_209b03d96b38dcc9e287f53f5ca" PRIMARY KEY ("id"))`);
