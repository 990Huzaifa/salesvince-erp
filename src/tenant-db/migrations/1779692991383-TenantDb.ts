...
export class TenantDb1779692991383 implements MigrationInterface {
    name = 'TenantDb1779692991383'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_stock_balances_active_business_warehouse_product" ON "stock_balances" ("businessId", "warehouseId", "productId") WHERE "deletedAt" IS NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_stock_balances_active_business_warehouse_product"`);
