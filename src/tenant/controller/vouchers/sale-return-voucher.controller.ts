...
export class SaleReturnVoucherController {
  ...
  @RequirePermissions('EDIT_APPROVED_SALE_RETURN_VOUCHER')
  editApproved(
    @TenantConnection() tenantDb: DataSource,
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: UpdateSaleReturnVoucherDto,
    ...
    const user = req.user as TenantRequestUser;
    return this.saleReturnVoucherService.editApproved(
      tenantDb,
      user.businessId!,
      id,
      dto,
  ...
  reject(
    ...
    const user = req.user as TenantRequestUser;
    return this.saleReturnVoucherService.reject(
      tenantDb,
      user.businessId!,
      id,
      user.userId,
  ...
  cancel(
    ...
    const user = req.user as TenantRequestUser;
    return this.saleReturnVoucherService.cancel(
      tenantDb,
      user.businessId!,
      id,
      user.userId,
